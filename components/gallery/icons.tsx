...
export const GridIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3.375 19.5h17.25m-17.25 0a1.125 1.125 0 0 1-1.125-1.125M3.375 19.5h7.5c.621 0 1.125-.504 1.125-1.125m-9.75 0V5.625m0 12.75v-1.5c0-.621.504-1.125 1.125-1.125m18.375 2.625H3.375m0 0a1.125 1.125 0 0 1-1.125-1.125m1.125 1.125v-1.5m0 0c0-.621.504-1.125 1.125-1.125m18.375 0a1.125 1.125 0 0 1 1.125 1.125v1.5m0 0a1.125 1.125 0 0 1-1.125 1.125H3.375m17.25 0a1.125 1.125 0 0 1-1.125-1.125M3.375 19.5v-1.5m0 0c0-.621.504-1.125 1.125-1.125m0 0h9.75m-9.75 0V5.625m0 0h9.75m-9.75 0c0-.621.504-1.125 1.125-1.125m9.75 0v1.5m0 0c0 .621-.504 1.125-1.125 1.125m0 0h-9.75m9.75 0v1.5m0 0c0 .621-.504 1.125-1.125 1.125m0 0h-9.75"
    />
  </svg>
);
